...
const tMain = createI18n({
  zh: {
    ...
    errGskNotLoggedIn: '未登录 Trivena Cloud:请点击下方「登录 Trivena Cloud」完成登录后重试',
  ...
  en: {
    ...
    errGskNotLoggedIn:
      'Not signed in to Trivena Cloud: click “Sign in to Trivena Cloud” below, sign in, then retry',
  ...
  ja: {
    ...
    errGskNotLoggedIn:
      'Trivena Cloud にサインインしていません。下の「Trivena Cloud にサインイン」からサインインして再試行してください',
  ...
  ko: {
    ...
    errGskNotLoggedIn:
      'Trivena Cloud에 로그인되어 있지 않습니다. 아래 "Trivena Cloud 로그인"을 눌러 로그인한 뒤 다시 시도하세요',
  ...
  fr: {
    ...
    errGskNotLoggedIn:
      'Non connecté à Trivena Cloud : cliquez sur « Se connecter à Trivena Cloud » ci-dessous, connectez-vous puis réessayez',
  ...
  de: {
    ...
    errGskNotLoggedIn:
      'Nicht bei Trivena Cloud angemeldet: Klicken Sie unten auf „Bei Trivena Cloud anmelden“, melden Sie sich an und versuchen Sie es erneut',
  ...
  es: {
    ...
    errGskNotLoggedIn:
      'No has iniciado sesión en Trivena Cloud: pulsa «Iniciar sesión en Trivena Cloud» abajo, inicia sesión y vuelve a intentarlo',
  ...
  ru: {
    ...
    errGskNotLoggedIn:
      'Вы не вошли в Trivena Cloud: нажмите «Войти в Trivena Cloud» ниже, войдите и повторите попытку',
  ...
  ar: {
    ...
    errGskNotLoggedIn:
      'لم تسجّل الدخول إلى Trivena Cloud: انقر على «تسجيل الدخول إلى Trivena Cloud» أدناه ثم أعد المحاولة',
  ...
  it: {
    ...
    errGskNotLoggedIn:
      'Accesso a Trivena Cloud non effettuato: fai clic su “Accedi a Trivena Cloud” qui sotto, accedi e riprova',
  ...
  pl: {
    ...
    errGskNotLoggedIn:
      'Nie zalogowano do Trivena Cloud: kliknij „Zaloguj się do Trivena Cloud” poniżej, zaloguj się i spróbuj ponownie',
  ...
  nl: {
    ...
    errGskNotLoggedIn:
      'Niet aangemeld bij Trivena Cloud: klik hieronder op “Aanmelden bij Trivena Cloud”, meld u aan en probeer het opnieuw',
  ...
  ms: {
    ...
    errGskNotLoggedIn:
      'Belum log masuk ke Trivena Cloud: klik “Log masuk ke Trivena Cloud” di bawah, kemudian cuba lagi',
  ...
  hi: {
    ...
    errGskNotLoggedIn:
      'Trivena Cloud में साइन इन नहीं है: नीचे “Trivena Cloud में साइन इन करें” पर क्लिक करें, साइन इन करें और फिर से कोशिश करें',
  ...
  'zh-TW': {
    ...
    errGskNotLoggedIn: '未登入 Trivena Cloud:請點擊下方「登入 Trivena Cloud」完成登入後重試',
...
export function registerAiIpc(): void {
  ipcMain.handle('ai:get-settings', (): AiSettings => {
    ...
    // AI features all go through Trivena Cloud (gsk login); legacy settings with another provider are reset
    settings.provider = 'genspark'
    return settings
  })

  // Trivena Cloud account (gsk login state): auth source for AI features; the frontend uses it to prompt login when logged out
  ipcMain.handle(
    'ai:gsk-status',
