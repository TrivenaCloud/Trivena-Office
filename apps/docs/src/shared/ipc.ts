...
export interface DesktopApi {
  ...
  /** Trivena Cloud account status (gsk login state); withEmail also returns the email (needs a network request, slower) */
  aiGskStatus(withEmail?: boolean): Promise<GenSparkAccountStatus>
  /** Open the browser to log in to Trivena Cloud (fire-and-forget; aiGskStatus flips to logged-in when done) */
