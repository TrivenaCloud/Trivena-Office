...
const sans = readWoff2(join(FONTS, 'TrivOfficeSansKR-Regular-subset.woff2'))
const serif = readWoff2(join(FONTS, 'TrivOfficeSerifKR-Regular-subset.woff2'))

describe('TrivOffice Sans KR (Malgun-normalized)', () => {
...
describe('TrivOffice Serif KR (Batang-normalized)', () => {
