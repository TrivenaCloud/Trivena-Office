...
import { gskListPastProjects, type GskPastProjectsPage } from '@trivoffice/ai-search'
import {
  cloudStoreOwner,
...
vi.mock('@trivoffice/ai-search', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@trivoffice/ai-search')>()
