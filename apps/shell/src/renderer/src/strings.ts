...
export const strings = {
  zh: {
    ...
    noContent: '（无内容）',
    // Account
    accountTrivenaCloud: 'Trivena Cloud 账号',
    account: '账号',
    login: '登录',
    loginTrivenaCloud: '登录 Trivena Cloud 账号',
    loggedIn: '已登录',
    loggedInTrivenaCloud: '已登录 Trivena Cloud',
  ...
  en: {
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountTrivenaCloud: 'Trivena Cloud Account',
    account: 'Account',
    login: 'Sign in',
    loginTrivenaCloud: 'Sign in with Trivena Cloud',
    loggedIn: 'Signed in',
    loggedInTrivenaCloud: 'Signed in to Trivena Cloud',
  ...
  ja: {
    ...
    noContent: '（内容なし）',
    // Account
    accountTrivenaCloud: 'Trivena Cloud アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginTrivenaCloud: 'Trivena Cloud アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInTrivenaCloud: 'Trivena Cloud にサインイン済み',
    waitingLogin:
  ...
  ko: {
    ...
    noContent: '(내용 없음)',
    // Account
    accountTrivenaCloud: 'Trivena Cloud 계정',
    account: '계정',
    login: '로그인',
    loginTrivenaCloud: 'Trivena Cloud 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInTrivenaCloud: 'Trivena Cloud에 로그인됨',
  ...
  fr: {
    ...
    noContent: '(vide)',
    // Account
    accountTrivenaCloud: 'Compte Trivena Cloud',
    account: 'Compte',
    login: 'Se connecter',
    loginTrivenaCloud: 'Se connecter avec Trivena Cloud',
    loggedIn: 'Connecté',
    loggedInTrivenaCloud: 'Connecté à Trivena Cloud',
    waitingLogin:
  ...
  de: {
    ...
    noContent: '(leer)',
    // Account
    accountTrivenaCloud: 'Trivena Cloud-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginTrivenaCloud: 'Mit Trivena Cloud anmelden',
    loggedIn: 'Angemeldet',
    loggedInTrivenaCloud: 'Bei Trivena Cloud angemeldet',
    waitingLogin:
  ...
  es: {
    ...
    noContent: '(vacío)',
    // Account
    accountTrivenaCloud: 'Cuenta de Trivena Cloud',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginTrivenaCloud: 'Iniciar sesión con Trivena Cloud',
    loggedIn: 'Sesión iniciada',
    loggedInTrivenaCloud: 'Sesión iniciada en Trivena Cloud',
    waitingLogin:
  ...
  th: {
    ...
    // Account
    accountTrivenaCloud: 'บัญชี Trivena Cloud',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginTrivenaCloud: 'ลงชื่อเข้าใช้ด้วย Trivena Cloud',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInTrivenaCloud: 'ลงชื่อเข้าใช้ Trivena Cloud แล้ว',
    ...
    loginNetworkError:
      'ไม่สามารถเชื่อมต่อ Trivena Cloud ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
  ...
  id: {
    ...
    noContent: '(kosong)',
    // Account
    accountTrivenaCloud: 'Akun Trivena Cloud',
    account: 'Akun',
    login: 'Masuk',
    loginTrivenaCloud: 'Masuk dengan Trivena Cloud',
    loggedIn: 'Sudah masuk',
    loggedInTrivenaCloud: 'Sudah masuk ke Trivena Cloud',
  ...
  ru: {
    ...
    noContent: '(пусто)',
    // Account
    accountTrivenaCloud: 'Учётная запись Trivena Cloud',
    account: 'Учётная запись',
    login: 'Войти',
    loginTrivenaCloud: 'Войти через Trivena Cloud',
    loggedIn: 'Вход выполнен',
    loggedInTrivenaCloud: 'Выполнен вход в Trivena Cloud',
    ...
    loginNetworkError:
      'Не удаётся подключиться к Trivena Cloud — проверьте сеть или настройки прокси',
  ...
  ar: {
    ...
    noContent: '(فارغ)',
    // Account
    accountTrivenaCloud: 'حساب Trivena Cloud',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginTrivenaCloud: 'تسجيل الدخول باستخدام Trivena Cloud',
    loggedIn: 'تم تسجيل الدخول',
    loggedInTrivenaCloud: 'تم تسجيل الدخول إلى Trivena Cloud',
  ...
  pt: {
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountTrivenaCloud: 'Conta Trivena Cloud',
    account: 'Conta',
    login: 'Entrar',
    loginTrivenaCloud: 'Entrar com a Trivena Cloud',
    loggedIn: 'Conectado',
    loggedInTrivenaCloud: 'Conectado à Trivena Cloud',
  ...
  it: {
    ...
    noContent: '(vuoto)',
    accountTrivenaCloud: 'Account Trivena Cloud',
    account: 'Account',
    login: 'Accedi',
    loginTrivenaCloud: 'Accedi con Trivena Cloud',
    loggedIn: 'Accesso effettuato',
    loggedInTrivenaCloud: 'Accesso effettuato a Trivena Cloud',
  ...
  pl: {
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountTrivenaCloud: 'Konto Trivena Cloud',
    account: 'Konto',
    login: 'Zaloguj się',
    loginTrivenaCloud: 'Zaloguj się przez Trivena Cloud',
    loggedIn: 'Zalogowano',
    loggedInTrivenaCloud: 'Zalogowano do Trivena Cloud',
    waitingLogin:
  ...
  nl: {
    ...
    account: 'Account',
    login: 'Inloggen',
    loginTrivenaCloud: 'Inloggen met Trivena Cloud',
    loggedIn: 'Ingelogd',
    loggedInTrivenaCloud: 'Ingelogd bij Trivena Cloud',
    ...
    loginNetworkError:
      'Kan Trivena Cloud niet bereiken — controleer uw netwerk of proxyinstellingen',
  ...
  ms: {
    ...
    noContent: '(kosong)',
    accountTrivenaCloud: 'Akaun Trivena Cloud',
    account: 'Akaun',
    login: 'Log masuk',
    loginTrivenaCloud: 'Log masuk dengan Trivena Cloud',
    loggedIn: 'Telah log masuk',
    loggedInTrivenaCloud: 'Telah log masuk ke Trivena Cloud',
  ...
  he: {
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountTrivenaCloud: 'חשבון Trivena Cloud',
    account: 'חשבון',
    login: 'התחברות',
    loginTrivenaCloud: 'התחברות עם Trivena Cloud',
    loggedIn: 'מחובר',
    loggedInTrivenaCloud: 'מחובר ל-Trivena Cloud',
  ...
  hi: {
    ...
    cloudLoginHint:
      'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने Trivena Cloud खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountTrivenaCloud: 'Trivena Cloud खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginTrivenaCloud: 'Trivena Cloud से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInTrivenaCloud: 'Trivena Cloud में साइन इन है',
    waitingLogin:
  ...
  'zh-TW': {
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountTrivenaCloud: 'Trivena Cloud 帳號',
    account: '帳號',
    login: '登入',
    loginTrivenaCloud: '登入 Trivena Cloud 帳號',
    loggedIn: '已登入',
    loggedInTrivenaCloud: '已登入 Trivena Cloud',
