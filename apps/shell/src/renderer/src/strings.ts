...
export const strings = {
  zh: {
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle: '在网页端用 Trivena AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 Trivena Cloud 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    noContent: '（无内容）',
    // Account
    accountTrivena Cloud: 'Trivena Cloud 账号',
    account: '账号',
    login: '登录',
    loginTrivena Cloud: '登录 Trivena Cloud 账号',
    loggedIn: '已登录',
    loggedInTrivena Cloud: '已登录 Trivena Cloud',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 Trivena Cloud,请检查网络或代理设置',
    ...
    onbTitle1: '欢迎使用 TrivOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'TrivOffice 目前处于 alpha 阶段。欢迎加入 Trivena 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ Trivena Cloud 积分**',
    onbJoinCommunity: '加入 Trivena',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
    ...
    onbNote3: 'AI 功能可能消耗 Trivena Cloud 积分。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Projects created on the web with Trivena AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your Trivena Cloud account to see projects you created on the web.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountTrivena Cloud: 'Trivena Cloud Account',
    account: 'Account',
    login: 'Sign in',
    loginTrivena Cloud: 'Sign in with Trivena Cloud',
    loggedIn: 'Signed in',
    loggedInTrivena Cloud: 'Signed in to Trivena Cloud',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach Trivena Cloud — check your network or proxy settings',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to TrivOffice',
    ...
    onbBody2:
      'TrivOffice is still in alpha. Join the group chat on Trivena to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ Trivena Cloud credits**',
    onbJoinCommunity: 'Join Trivena',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features may consume Trivena Cloud credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Web で Trivena AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'Trivena Cloud アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountTrivena Cloud: 'Trivena Cloud アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginTrivena Cloud: 'Trivena Cloud アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInTrivena Cloud: 'Trivena Cloud にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'Trivena Cloud に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'TrivOffice へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'TrivOffice はまだアルファ版です。Trivena のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ Trivena Cloud クレジット**',
    onbJoinCommunity: 'Trivena に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は Trivena Cloud クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Trivena AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'Trivena Cloud 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    noContent: '(내용 없음)',
    // Account
    accountTrivena Cloud: 'Trivena Cloud 계정',
    account: '계정',
    login: '로그인',
    loginTrivena Cloud: 'Trivena Cloud 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInTrivena Cloud: 'Trivena Cloud에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'Trivena Cloud에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'TrivOffice에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'TrivOffice는 아직 알파 단계입니다. Trivena 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ Trivena Cloud 크레딧**',
    onbJoinCommunity: 'Trivena 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 기능은 Trivena Cloud 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      "Projets créés sur le web avec Trivena AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte Trivena Cloud pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountTrivena Cloud: 'Compte Trivena Cloud',
    account: 'Compte',
    login: 'Se connecter',
    loginTrivena Cloud: 'Se connecter avec Trivena Cloud',
    loggedIn: 'Connecté',
    loggedInTrivena Cloud: 'Connecté à Trivena Cloud',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre Trivena Cloud — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans TrivOffice',
    ...
    onbBody2:
      'TrivOffice est encore en alpha. Rejoignez la discussion de groupe sur Trivena pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Trivena Cloud**',
    onbJoinCommunity: 'Rejoindre Trivena',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits Trivena Cloud.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Mit Trivena AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem Trivena Cloud-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    noContent: '(leer)',
    // Account
    accountTrivena Cloud: 'Trivena Cloud-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginTrivena Cloud: 'Mit Trivena Cloud anmelden',
    loggedIn: 'Angemeldet',
    loggedInTrivena Cloud: 'Bei Trivena Cloud angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'Trivena Cloud ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei TrivOffice',
    ...
    onbBody2:
      'TrivOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf Trivena bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Trivena Cloud-Guthaben**',
    onbJoinCommunity: 'Trivena beitreten',
    ...
    onbNote3: 'KI-Funktionen können Trivena Cloud-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Proyectos creados en la web con Trivena AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de Trivena Cloud para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountTrivena Cloud: 'Cuenta de Trivena Cloud',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginTrivena Cloud: 'Iniciar sesión con Trivena Cloud',
    loggedIn: 'Sesión iniciada',
    loggedInTrivena Cloud: 'Sesión iniciada en Trivena Cloud',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con Trivena Cloud — compruebe su red o la configuración del proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a TrivOffice',
    ...
    onbBody2:
      'TrivOffice aún está en alfa. Únete al chat grupal en Trivena para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Trivena Cloud**',
    onbJoinCommunity: 'Unirse a Trivena',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de Trivena Cloud.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย Trivena AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี Trivena Cloud เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountTrivena Cloud: 'บัญชี Trivena Cloud',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginTrivena Cloud: 'ลงชื่อเข้าใช้ด้วย Trivena Cloud',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInTrivena Cloud: 'ลงชื่อเข้าใช้ Trivena Cloud แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ Trivena Cloud ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ TrivOffice',
    ...
    onbBody2:
      'TrivOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน Trivena เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Trivena Cloud กว่า 1,000**',
    onbJoinCommunity: 'เข้าร่วม Trivena',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต Trivena Cloud',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan Trivena AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun Trivena Cloud untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountTrivena Cloud: 'Akun Trivena Cloud',
    account: 'Akun',
    login: 'Masuk',
    loginTrivena Cloud: 'Masuk dengan Trivena Cloud',
    loggedIn: 'Sudah masuk',
    loggedInTrivena Cloud: 'Sudah masuk ke Trivena Cloud',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke Trivena Cloud — periksa jaringan atau pengaturan proxy Anda',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di TrivOffice',
    ...
    onbBody2:
      'TrivOffice masih dalam tahap alpha. Gabung obrolan grup di Trivena untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Trivena Cloud**',
    onbJoinCommunity: 'Gabung Trivena',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit Trivena Cloud.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с Trivena AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт Trivena Cloud, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountTrivena Cloud: 'Учётная запись Trivena Cloud',
    account: 'Учётная запись',
    login: 'Войти',
    loginTrivena Cloud: 'Войти через Trivena Cloud',
    loggedIn: 'Вход выполнен',
    loggedInTrivena Cloud: 'Выполнен вход в Trivena Cloud',
    ...
    loginNetworkError: 'Не удаётся подключиться к Trivena Cloud — проверьте сеть или настройки прокси',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в TrivOffice',
    ...
    onbBody2:
      'TrivOffice пока в альфа-версии. Присоединяйтесь к групповому чату в Trivena, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов Trivena Cloud**',
    onbJoinCommunity: 'Присоединиться к Trivena',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты Trivena Cloud.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام Trivena AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب Trivena Cloud لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountTrivena Cloud: 'حساب Trivena Cloud',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginTrivena Cloud: 'تسجيل الدخول باستخدام Trivena Cloud',
    loggedIn: 'تم تسجيل الدخول',
    loggedInTrivena Cloud: 'تم تسجيل الدخول إلى Trivena Cloud',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ Trivena Cloud — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في TrivOffice',
    ...
    onbBody2:
      'لا يزال TrivOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على Trivena لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Trivena Cloud**',
    onbJoinCommunity: 'الانضمام إلى Trivena',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة Trivena Cloud.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Projetos criados na web com o Trivena AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta Trivena Cloud para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountTrivena Cloud: 'Conta Trivena Cloud',
    account: 'Conta',
    login: 'Entrar',
    loginTrivena Cloud: 'Entrar com a Trivena Cloud',
    loggedIn: 'Conectado',
    loggedInTrivena Cloud: 'Conectado à Trivena Cloud',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao Trivena Cloud — verifique sua rede ou as configurações de proxy',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao TrivOffice',
    ...
    onbBody2:
      'O TrivOffice ainda está em alfa. Entre no chat em grupo no Trivena para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Trivena Cloud**',
    onbJoinCommunity: 'Entrar no Trivena',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos Trivena Cloud.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Progetti creati sul web con Trivena AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account Trivena Cloud per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountTrivena Cloud: 'Account Trivena Cloud',
    account: 'Account',
    login: 'Accedi',
    loginTrivena Cloud: 'Accedi con Trivena Cloud',
    loggedIn: 'Accesso effettuato',
    loggedInTrivena Cloud: 'Accesso effettuato a Trivena Cloud',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere Trivena Cloud — controlla la rete o le impostazioni del proxy',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in TrivOffice',
    ...
    onbBody2:
      'TrivOffice è ancora in alpha. Unisciti alla chat di gruppo su Trivena per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Trivena Cloud**',
    onbJoinCommunity: 'Unisciti a Trivena',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti Trivena Cloud.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą Trivena AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto Trivena Cloud, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountTrivena Cloud: 'Konto Trivena Cloud',
    account: 'Konto',
    login: 'Zaloguj się',
    loginTrivena Cloud: 'Zaloguj się przez Trivena Cloud',
    loggedIn: 'Zalogowano',
    loggedInTrivena Cloud: 'Zalogowano do Trivena Cloud',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z Trivena Cloud — sprawdź sieć lub ustawienia proxy',
    ...
    onbBody2:
      'TrivOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na Trivena, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Trivena Cloud**',
    onbJoinCommunity: 'Dołącz do Trivena',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty Trivena Cloud.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met Trivena AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je Trivena Cloud-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginTrivena Cloud: 'Inloggen met Trivena Cloud',
    loggedIn: 'Ingelogd',
    loggedInTrivena Cloud: 'Ingelogd bij Trivena Cloud',
    ...
    loginNetworkError: 'Kan Trivena Cloud niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij TrivOffice',
    ...
    onbBody2:
      'TrivOffice is nog in alfa. Doe mee aan de groepschat op Trivena om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Trivena Cloud-credits**',
    onbJoinCommunity: 'Word lid van Trivena',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies kunnen Trivena Cloud-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan Trivena AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun Trivena Cloud untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountTrivena Cloud: 'Akaun Trivena Cloud',
    account: 'Akaun',
    login: 'Log masuk',
    loginTrivena Cloud: 'Log masuk dengan Trivena Cloud',
    loggedIn: 'Telah log masuk',
    loggedInTrivena Cloud: 'Telah log masuk ke Trivena Cloud',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke Trivena Cloud — semak rangkaian atau tetapan proksi anda',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke TrivOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'TrivOffice masih dalam peringkat alfa. Sertai sembang kumpulan di Trivena untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Trivena Cloud**',
    onbJoinCommunity: 'Sertai Trivena',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit Trivena Cloud.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם Trivena AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון Trivena Cloud כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountTrivena Cloud: 'חשבון Trivena Cloud',
    account: 'חשבון',
    login: 'התחברות',
    loginTrivena Cloud: 'התחברות עם Trivena Cloud',
    loggedIn: 'מחובר',
    loggedInTrivena Cloud: 'מחובר ל-Trivena Cloud',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Trivena Cloud — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-TrivOffice',
    ...
    onbBody2:
      'TrivOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-Trivena כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Trivena Cloud**',
    onbJoinCommunity: 'הצטרפו ל-Trivena',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של Trivena Cloud.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle:
      'Trivena AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने Trivena Cloud खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountTrivena Cloud: 'Trivena Cloud खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginTrivena Cloud: 'Trivena Cloud से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInTrivena Cloud: 'Trivena Cloud में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'Trivena Cloud से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'TrivOffice में आपका स्वागत है',
    ...
    onbBody2:
      'TrivOffice अभी अल्फ़ा में है। Trivena पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Trivena Cloud क्रेडिट**',
    onbJoinCommunity: 'Trivena से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ Trivena Cloud क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'Trivena Cloud Projects',
    cloudSubtitle: '在網頁端用 Trivena AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 Trivena Cloud 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountTrivena Cloud: 'Trivena Cloud 帳號',
    account: '帳號',
    login: '登入',
    loginTrivena Cloud: '登入 Trivena Cloud 帳號',
    loggedIn: '已登入',
    loggedInTrivena Cloud: '已登入 Trivena Cloud',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 Trivena Cloud，請檢查網路或代理設定',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 TrivOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'TrivOffice 目前仍在 alpha 階段。歡迎加入 Trivena 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ Trivena Cloud 點數**',
    onbJoinCommunity: '加入 Trivena',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能可能消耗 Trivena Cloud 點數。',
    onbBack: '上一步',
  },
} as const
