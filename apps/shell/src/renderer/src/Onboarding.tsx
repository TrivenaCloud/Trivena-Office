...
interface Slide {
  ...
  bodyDim?: boolean
  /** community slide shows the credits offer panel with the "Join Trivena" call-to-action */
  showOffer?: boolean
  art: 'logo' | 'gift' | 'check'
}
...
export function Onboarding({ onDone }: OnboardingProps) {
  ...
  // makes its Trivena button inert, which blurs it) — pull focus back onto the
