/**
 * Shared main-process state for TrivOffice Slides, extracted from slides-main.ts so
...
import { materializeSlide, type OpenedPptx, type Slide } from '@trivoffice/pptx-engine'
import {
  buildRenderSlide,
