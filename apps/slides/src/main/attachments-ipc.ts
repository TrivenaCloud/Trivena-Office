...
import { showOpenDialogWithMemory } from '@trivoffice/electron-utils'
...
/** office/pdf formats extract text via @trivoffice/file-parse; images skip text extraction and go multimodal (slides:files-read-image) */
...
/** Extract attachment text via @trivoffice/file-parse (docx/pdf/pptx/xlsx/plain text) */
