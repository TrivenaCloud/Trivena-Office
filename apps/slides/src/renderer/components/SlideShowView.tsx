...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@trivoffice/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@trivoffice/pptx-render').PictureRenderNode =>
      n.type === 'picture' && !!(n as import('@trivoffice/pptx-render').PictureRenderNode).media,
  )
