import { defineStrings } from '@trivoffice/i18n'
...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiGskLoginBtn: '登录 Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Trivena Cloud 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 Trivena Cloud 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginTrivenaCloud: '登录 Trivena Cloud',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
    aiTimeoutError: 'AI 请求超时：网络长时间无响应，已停止。请检查网络后重试',
    aiCreditsExhausted: 'Trivena Cloud 积分已用完，请前往 cloud.trivena.tech 充值后重试',
  ...
  en: {
    ...
    aiGskLoginBtn: 'Sign in to Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Trivena Cloud account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a Trivena Cloud account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginTrivenaCloud: 'Sign in to Trivena Cloud',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
    ...
    aiCreditsExhausted:
      'Your Trivena Cloud credits have run out. Visit cloud.trivena.tech to top up, then try again',
  ...
  ja: {
    ...
    aiGskLoginBtn: 'Trivena Cloud にサインイン',
    ...
    aiTrivenaCloudAccount: 'Trivena Cloud アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には Trivena Cloud アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginTrivenaCloud: 'Trivena Cloud にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
    ...
    aiCreditsExhausted:
      'Trivena Cloudクレジットを使い切りました。cloud.trivena.tech でチャージしてから再試行してください',
  ...
  ko: {
    ...
    aiGskLoginBtn: 'Trivena Cloud 로그인',
    ...
    aiTrivenaCloudAccount: 'Trivena Cloud 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 Trivena Cloud 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginTrivenaCloud: 'Trivena Cloud 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
    ...
    aiCreditsExhausted:
      'Trivena Cloud 크레딧을 모두 사용했습니다. cloud.trivena.tech에서 충전한 후 다시 시도해 주세요',
  ...
  fr: {
    ...
    aiGskLoginBtn: 'Se connecter à Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Compte Trivena Cloud',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte Trivena Cloud)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginTrivenaCloud: 'Se connecter à Trivena Cloud',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
    ...
    aiCreditsExhausted:
      'Vos crédits Trivena Cloud sont épuisés. Rechargez sur cloud.trivena.tech puis réessayez',
  ...
  de: {
    ...
    aiGskLoginBtn: 'Bei Trivena Cloud anmelden',
    ...
    aiTrivenaCloudAccount: 'Trivena Cloud-Konto',
    aiAccountChecking: 'Wird überprüft…',
    aiLoggedIn: 'Angemeldet',
    aiLoggedInAs: 'Angemeldet: {email}',
    aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein Trivena Cloud-Konto)',
    aiWaitingBrowserLogin: 'Warten auf Anmeldung im Browser…',
    aiLoginTrivenaCloud: 'Bei Trivena Cloud anmelden',
    aiModel: 'Modell',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
    ...
    aiCreditsExhausted:
      'Deine Trivena Cloud-Credits sind aufgebraucht. Lade unter cloud.trivena.tech auf und versuche es erneut',
  ...
  es: {
    ...
    aiGskLoginBtn: 'Iniciar sesión en Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Cuenta de Trivena Cloud',
    ...
    aiCreditsExhausted:
      'Tus créditos de Trivena Cloud se han agotado. Recarga en cloud.trivena.tech e inténtalo de nuevo',
  ...
  th: {
    ...
    aiGskLoginBtn: 'ลงชื่อเข้าใช้ Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'บัญชี Trivena Cloud',
    aiAccountChecking: 'กำลังตรวจสอบ…',
    aiLoggedIn: 'ลงชื่อเข้าใช้แล้ว',
    aiLoggedInAs: 'ลงชื่อเข้าใช้แล้ว: {email}',
    aiNotLoggedIn: 'ยังไม่ได้ลงชื่อเข้าใช้ (ฟีเจอร์ AI ต้องใช้บัญชี Trivena Cloud)',
    aiWaitingBrowserLogin: 'กำลังรอการลงชื่อเข้าใช้ในเบราว์เซอร์…',
    aiLoginTrivenaCloud: 'ลงชื่อเข้าใช้ Trivena Cloud',
    aiModel: 'โมเดล',
    aiCancel: 'ยกเลิก',
    aiSave: 'บันทึก',
    ...
    aiCreditsExhausted:
      'เครดิต Trivena Cloud ของคุณหมดแล้ว โปรดเติมเครดิตที่ cloud.trivena.tech แล้วลองใหม่',
  ...
  id: {
    ...
    aiGskLoginBtn: 'Masuk ke Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Akun Trivena Cloud',
    aiAccountChecking: 'Memeriksa…',
    aiLoggedIn: 'Sudah masuk',
    aiLoggedInAs: 'Sudah masuk: {email}',
    aiNotLoggedIn: 'Belum masuk (fitur AI memerlukan akun Trivena Cloud)',
    aiWaitingBrowserLogin: 'Menunggu proses masuk di browser…',
    aiLoginTrivenaCloud: 'Masuk ke Trivena Cloud',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
    ...
    aiCreditsExhausted:
      'Kredit Trivena Cloud Anda telah habis. Isi ulang di cloud.trivena.tech lalu coba lagi',
  ...
  ru: {
    ...
    aiGskLoginBtn: 'Войти в Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Учётная запись Trivena Cloud',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Trivena Cloud)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginTrivenaCloud: 'Войти в Trivena Cloud',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
    ...
    aiCreditsExhausted:
      'Кредиты Trivena Cloud исчерпаны. Пополните баланс на cloud.trivena.tech и повторите попытку',
  ...
  ar: {
    ...
    aiGskLoginBtn: 'تسجيل الدخول إلى Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'حساب Trivena Cloud',
    aiAccountChecking: 'جارٍ التحقق…',
    aiLoggedIn: 'تم تسجيل الدخول',
    aiLoggedInAs: 'تم تسجيل الدخول: {email}',
    aiNotLoggedIn: 'لم يتم تسجيل الدخول (تتطلب ميزات الذكاء الاصطناعي حساب Trivena Cloud)',
    aiWaitingBrowserLogin: 'في انتظار تسجيل الدخول من المتصفح…',
    aiLoginTrivenaCloud: 'تسجيل الدخول إلى Trivena Cloud',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
    ...
    aiCreditsExhausted:
      'نفدت أرصدة Trivena Cloud لديك. يرجى إعادة الشحن عبر cloud.trivena.tech ثم المحاولة مجددًا',
  ...
  pt: {
    ...
    aiGskLoginBtn: 'Entrar no Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Conta Trivena Cloud',
    aiAccountChecking: 'Verificando…',
    aiLoggedIn: 'Conectado',
    aiLoggedInAs: 'Conectado: {email}',
    aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta Trivena Cloud)',
    aiWaitingBrowserLogin: 'Aguardando login no navegador…',
    aiLoginTrivenaCloud: 'Entrar no Trivena Cloud',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
    ...
    aiCreditsExhausted:
      'Seus créditos Trivena Cloud acabaram. Recarregue em cloud.trivena.tech e tente novamente',
  ...
  it: {
    ...
    aiGskLoginBtn: 'Accedi a Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Account Trivena Cloud',
    aiAccountChecking: 'Verifica in corso…',
    aiLoggedIn: 'Accesso effettuato',
    aiLoggedInAs: 'Accesso effettuato: {email}',
    aiNotLoggedIn: 'Accesso non effettuato (le funzioni IA richiedono un account Trivena Cloud)',
    aiWaitingBrowserLogin: "In attesa dell'accesso nel browser…",
    aiLoginTrivenaCloud: 'Accedi a Trivena Cloud',
    aiModel: 'Modello',
    aiCancel: 'Annulla',
    aiSave: 'Salva',
    ...
    aiCreditsExhausted:
      'I tuoi crediti Trivena Cloud sono esauriti. Ricarica su cloud.trivena.tech e riprova',
  ...
  pl: {
    ...
    aiGskLoginBtn: 'Zaloguj się do Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Konto Trivena Cloud',
    aiAccountChecking: 'Sprawdzanie…',
    aiLoggedIn: 'Zalogowano',
    aiLoggedInAs: 'Zalogowano: {email}',
    aiNotLoggedIn: 'Nie zalogowano (funkcje AI wymagają konta Trivena Cloud)',
    aiWaitingBrowserLogin: 'Oczekiwanie na logowanie w przeglądarce…',
    aiLoginTrivenaCloud: 'Zaloguj się do Trivena Cloud',
    aiModel: 'Model',
    aiCancel: 'Anuluj',
    aiSave: 'Zapisz',
    ...
    aiCreditsExhausted:
      'Twoje kredyty Trivena Cloud wyczerpały się. Doładuj konto na cloud.trivena.tech i spróbuj ponownie',
  ...
  nl: {
    ...
    aiGskLoginBtn: 'Aanmelden bij Trivena Cloud',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een Trivena Cloud-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginTrivenaCloud: 'Aanmelden bij Trivena Cloud',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
    ...
    aiCreditsExhausted:
      'Je Trivena Cloud-credits zijn op. Waardeer op via cloud.trivena.tech en probeer het opnieuw',
  ...
  ms: {
    ...
    aiGskLoginBtn: 'Log masuk ke Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Akaun Trivena Cloud',
    aiAccountChecking: 'Sedang menyemak…',
    aiLoggedIn: 'Sudah log masuk',
    aiLoggedInAs: 'Sudah log masuk: {email}',
    aiNotLoggedIn: 'Belum log masuk (ciri AI memerlukan akaun Trivena Cloud)',
    aiWaitingBrowserLogin: 'Menunggu log masuk dalam pelayar…',
    aiLoginTrivenaCloud: 'Log masuk ke Trivena Cloud',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
    ...
    aiCreditsExhausted:
      'Kredit Trivena Cloud anda telah habis. Tambah nilai di cloud.trivena.tech dan cuba lagi',
  ...
  he: {
    ...
    aiGskLoginBtn: 'התחבר ל-Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'חשבון Trivena Cloud',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון Trivena Cloud)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginTrivenaCloud: 'כניסה ל-Trivena Cloud',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
    aiUnknownError: 'שגיאה לא ידועה',
    aiTimeoutError: 'תם הזמן לבקשת ה-AI: אין תגובה מהרשת וההרצה הופסקה. בדוק את החיבור ונסה שוב',
    aiCreditsExhausted: 'קרדיטי Trivena Cloud שלך אזלו. טען מחדש ב-cloud.trivena.tech ונסה שוב',
  ...
  hi: {
    ...
    aiGskLoginBtn: 'Trivena Cloud में साइन इन करें',
    ...
    aiTrivenaCloudAccount: 'Trivena Cloud खाता',
    aiAccountChecking: 'जांच हो रही है…',
    aiLoggedIn: 'साइन इन किया गया',
    aiLoggedInAs: 'साइन इन: {email}',
    aiNotLoggedIn: 'साइन इन नहीं है (AI सुविधाओं के लिए Trivena Cloud खाता आवश्यक है)',
    aiWaitingBrowserLogin: 'ब्राउज़र में साइन इन की प्रतीक्षा…',
    aiLoginTrivenaCloud: 'Trivena Cloud में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
    ...
    aiCreditsExhausted:
      'आपके Trivena Cloud क्रेडिट समाप्त हो गए हैं। cloud.trivena.tech पर रिचार्ज करें और फिर से प्रयास करें',
  ...
  'zh-TW': {
    ...
    aiGskLoginBtn: '登入 Trivena Cloud',
    ...
    aiTrivenaCloudAccount: 'Trivena Cloud 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 Trivena Cloud 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginTrivenaCloud: '登入 Trivena Cloud',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
    aiTimeoutError: 'AI 請求逾時：網路長時間無回應，已停止。請檢查網路後重試',
    aiCreditsExhausted: 'Trivena Cloud 點數已用完，請前往 cloud.trivena.tech 儲值後重試',
