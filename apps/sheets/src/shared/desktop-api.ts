...
// ---- AI settings + chat/stream: canonical types live in @trivoffice/ai-provider,
...
export interface DesktopApi {
  ...
  /// Trivena Cloud account status (gsk login state); withEmail also returns the email
  /// (needs a network request, slower)
  aiGskStatus(withEmail?: boolean): Promise<GenSparkAccountStatus>
  /// Opens the browser to sign in to Trivena Cloud (fire-and-forget; aiGskStatus
